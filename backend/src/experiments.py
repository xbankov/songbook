...
def main():
    ...
    transposed_file_path = config.NORMALIZED_DIR / f"wicked-game-transposed.txt"
    ...
    transposed = song.transpose(-3)

    with open(transposed_file_path, "w", encoding="utf-8") as f:
        f.write(str(transposed))
